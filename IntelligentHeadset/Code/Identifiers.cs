...
{
    /// <summary>
    /// Identifiers used in the system.
    /// </summary>
    class Identifiers
    {
        ...
        /// <summary>
        /// Creates a GUID from a well known 16-bit UUID.
        /// </summary>
        /// <param name="uuid16Bit">The 16-bit UUID.</param>
        /// <returns>A GUID for the well known 16-bit UUID.</returns>
